...
export const NotFoundPage = () => (
  <Box className='h-screen'>
    <Box className='h-headerHeight bg-ocean-green-500 px-4 pt-4'>
      <UnSignedHeader />
    </Box>
    <Box className='h-full w-full bg-ocean-green-100 pt-10'>
      <Stack className='items-center justify-center'>
        <span className='text-5xl text-ocean-green-900'>Whoops!</span>
        <span className='text-center text-xl text-ocean-green-900'>
