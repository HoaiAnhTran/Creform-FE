...
export const FileUpload = (props: FileUploadProps) => {
  ...
  return (
    <div className={cn('flex w-full flex-col', classNameWrapper)}>
      ...
      {uploadedFile ? (
        <Group className='h-max items-center justify-between gap-1 rounded-lg bg-ocean-green-50 p-3'>
        ...
        <Box
          className={cn(
            'flex flex-col items-center justify-center gap-2 rounded-lg border border-dashed border-slate-500 bg-slate-100 p-4',
            {
